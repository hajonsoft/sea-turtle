<%@ Page Title="Pool-bug-be-gone" Language="C#" MasterPageFile="~/Site.Master"
AutoEventWireup="true" CodeBehind="pool-bug-be-gone.aspx.cs"
Inherits="Seaturtlestore.pool_bug_be_gone" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" runat="server" contentplaceholderid="MainContent">
  <div>
    <img
      alt="pool bugs clean, Pool Cleaner, pool bug be gone, water bugs pool"
