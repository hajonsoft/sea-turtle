<%@ Page Title="Adopt Sea Turtle Nest to a Friend" Language="C#"
MasterPageFile="~/Site.Master" AutoEventWireup="true"
CodeBehind="Friend-Adopt-Sea-Turtle-Nest.aspx.cs"
Inherits="Seaturtlestore.Friend_Adopt_Sea_Turtle_Nest" %> <%--<%@ Register
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
  <div>
    <div class="text-center">
      <h3><b>ADOPT A SEA TURTLE NEST APPLICATION</b></h3>
    </div>
    ...
    <div class="col-lg-6">
      ...
      <div class="text-center">
        <b>Please send my gift to my friend: $40.00</b
        ><asp:Label
          ID="lblip"
          runat="server"
          Text="IP"
      ...
      <div class="form-group">
        <asp:RequiredFieldValidator
          ...
          runat="server"
          ErrorMessage="Please Type Your Friend's Name"
          ForeColor="Red"
          ControlToValidate="dfsFriend"
          >*
        </asp:RequiredFieldValidator>
        <b>Friend&#39;s Name :</b>
        <asp:TextBox
      ...
      <div class="form-group">
        <asp:RequiredFieldValidator
          ...
          runat="server"
          ErrorMessage="Please Type this gift from"
          ForeColor="Red"
          ControlToValidate="dfsGiftFrom"
          >*
        </asp:RequiredFieldValidator>
      ...
      <div class="form-group">
        <asp:Button
          ID="btnSubmitAdoptFriend"
          runat="server"
          Font-Bold="True"
          CssClass="btn btn-danger btn-lg btn-block"
          Text="Add to Cart"
          OnClick="btnSubmitAdoptFriend_Click"
        />
      </div>
    </div>
    <div class="col-lg-6">
      ...
      <div class="text-center" style="margin-top: 5px; margin-bottom: 5px">
        <b
          >If you prefer to mail your request, please use this
          <a href="Img/Adopt-A-Sea-Turtle-Nest.pdf" target="_blank">form</a></b
        >
      </div>
      <div style="margin-top: 5px; margin-bottom: 5px" class="text-center">
        <a
          ...
          ><b>Click Here to Adopt a Sea Turtle<br />for a Friend</b></a
        >
      </div>
    </div>
  </div>
