<%@ Page Title="Adopt a Sea Turtle Nest for a friend" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Adopt-a-Sea-Turtle-Nest-for-a-friend.aspx.cs" Inherits="Seaturtlestore.Adopt_a_Sea_Turtle_Nest_for_a_friend" %>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="MainContent">
    ...
    <div class="text-center"><h3><b>Adopt a Sea Turtle + 17” Green Sea Turtle for a friend</b></h3></div>
    ...
    <div class="form-group">
        ...
        <b>Your Name:</b><asp:TextBox ID="dfsName" runat="server" CssClass="form-control" ForeColor="Navy" ></asp:TextBox>


    </div>

    <div class="form-group">
        <b>Your Phone:</b><asp:TextBox ID="dfsPhone" runat="server" CssClass="form-control" ForeColor="Navy" ></asp:TextBox>
    </div>


    <div class="form-group">
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                            ErrorMessage="Please Type Your Email" ControlToValidate="dfsEmail" 
                            ForeColor="#E1BF14">* </asp:RequiredFieldValidator><b>Your E-mail Address:</b><asp:TextBox ID="dfsEmail" runat="server" CssClass="form-control" ForeColor="Navy" ></asp:TextBox>
    </div>

    <div class="form-group">
        <b>Your Friend Name:</b><asp:TextBox ID="dfsFName" runat="server" CssClass="form-control" ForeColor="Navy" ></asp:TextBox>
    </div>

    <div class="form-group">
        <b>Your Friend E-mail:</b><asp:TextBox ID="dfsFEmail" runat="server" CssClass="form-control" ForeColor="Navy" ></asp:TextBox>
    </div>

    <div class="form-group">

        <b>Your Friend Address:</b><asp:TextBox ID="dfsFaddress" runat="server" CssClass="form-control" ForeColor="Navy" ></asp:TextBox>
     ...
     <div class="form-group">
         ...
         <b>City:</b><asp:TextBox ID="dfsCity" runat="server" CssClass="form-control" ForeColor="Navy" ></asp:TextBox>

    </div>

     <div class="form-group">
         <b>State:</b><asp:DropDownList ID="FriendStateList" runat="server" ForeColor="Navy" CssClass="form-control">
    ...
    <div class="form-group">
        <b>Zip Code:</b><asp:TextBox ID="dfsFriendZip" runat="server" Width="80px" 
                            CssClass="form-control" ForeColor="Navy" ></asp:TextBox><asp:Label ID="lblip" runat="server" Text="IP" Visible="false"></asp:Label>
    ...
    <div class="form-group">
        <asp:ImageButton ID="btnAddtocartWildlifeAdoptNest" runat="server" class="btn btn-danger btn-lg" 
                                               ImageUrl="~/Img/AddtoCart.png" OnClick="btnAddtocartWildlifeAdoptNest_Click"/>
    </div>
