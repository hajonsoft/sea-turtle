<%@ Page Title="Membership tax deductible for a Friend" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Memberships-for-a-friend.aspx.cs" Inherits="Seaturtlestore.Memberships_for_a_friend" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   <div class="text-center">
                ...
                <div class="panel-heading"><h3><em>NEW TAX DEDUCTIBLE MEMBERSHIP OFFER</em></h3></div>
                    </div>
            </div>

    <div class="text-center"><b>
With each Membership you will receive a free one-year subscription to<br />
Florida Environmental Outreach Magazine.</b></div>

    <div>
        <div class="text-center" style="padding-top:10px; padding-bottom:10px"><b>Please send a gift to my friend : $25.00</b></div>
        <div class="col-lg-7">
            <div><asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="White" 
                            style="text-align: left" /></div>
            <div class="form-group">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ErrorMessage="Please Type Your Name" ControlToValidate="dfsName" 
...
<cc1:googlerecaptcha ID="ctrlGoogleReCaptcha" runat="server" PublicKey="6LcCmvwSAAAAAIQq1lhiP5R3lAuwMq4PlTEYGIda" PrivateKey="6LcCmvwSAAAAACvadIRndvtIUZt4M3hbKX6EWfmP" />
            ...
            <div class="form-group">
                <asp:Button ID="btnSubmitFriend" runat="server" Font-Bold="True" Text="Add to Cart" OnClick="btnSubmitFriend_Click" CssClass="btn btn-danger btn-lg btn-block"/>
        ...
        <div class="col-lg-5">
            <div style="margin-top:15px"><img alt="sea turtle store, Sea turtle, sea turtle stuff, buy Sea turtle nest" class="img-responsive center-block" src="Img/Membership-2.png" /></div>
            <div style="margin-top:15px"><a href="Memberships.aspx" class="btn btn-danger btn-lg" style="white-space:normal; word-break:break-all">Click Here to Order Membership For Yourself</a></div>
        </div>
