(function(b){function a(a,c,d){for(var b=a.length,i=c.length,f,k,l,p,n,o,m=0,q=0;q<b;q++){f=a[q];k=a[q<b-1?q+1:0];m=f.y-k.y;f=k.x-f.x;k=Math.sqrt(m*m+f*f);m/=k;f/=k;k=l=a[0].x*m+a[0].y*f;for(var r=1;r<b;r++)o=a[r].x*m+a[r].y*f,o>l?l=o:o<k&&(k=o);p=n=c[0].x*m+c[0].y*f;for(r=1;r<i;r++)o=c[r].x*m+c[r].y*f,o>n?n=o:o<p&&(p=o);k<p?(k=p-l,m=-m,f=-f):k-=n;if(0<=k)return!1;if(k>d.overlap)d.overlap=k,d.normal.x=m,d.normal.y=f}return d}var c=b.Quark=b.Quark||{version:"1.0.0",global:b},d=function(){};c.inherit=
...
(a/=0.5)?-0.5*(Math.sqrt(1-a*a)-1):0.5*(Math.sqrt(1-(a-=2)*a)+1)};a.Elastic.EaseIn=function(a){var d,b=0.1,e=0.4;if(0==a)return 0;if(1==a)return 1;e||(e=0.3);!b||1>b?(b=1,d=e/4):d=e/(2*Math.PI)*Math.asin(1/b);return-(b*Math.pow(2,10*(a-=1))*Math.sin(2*(a-d)*Math.PI/e))};a.Elastic.EaseOut=function(a){var b,h=0.1,e=0.4;if(0==a)return 0;if(1==a)return 1;e||(e=0.3);!h||1>h?(h=1,b=e/4):b=e/(2*Math.PI)*Math.asin(1/h);return h*Math.pow(2,-10*a)*Math.sin(2*(a-b)*Math.PI/e)+1};a.Elastic.EaseInOut=function(a){var b,
...
function(a){null!=this.update&&this.update(a);for(var c=this.children.slice(0),b=0,h=c.length;b<h;b++){var e=c[b];e._depth=b+1;e._update(a)}};b.prototype.render=function(a){b.superClass.render.call(this,a);for(var c=0,d=this.children.length;c<d;c++)this.children[c]._render(a)};b.prototype.getObjectUnderPoint=function(a,c,b,h){if(h)var e=[];for(var g=this.children.length-1;0<=g;g--){var j=this.children[g];if(!(null==j||!j.eventEnabled&&void 0==j.children||!j.visible||0>=j.alpha))if(void 0!=j.children&&
j.eventChildren&&0<j.getNumChildren()){var i=j.getObjectUnderPoint(a,c,b,h);if(i)if(h)0<i.length&&(e=e.concat(i));else return i;else if(0<=j.hitTestPoint(a,c,b))if(h)e.push(j);else return j}else if(0<=j.hitTestPoint(a,c,b))if(h)e.push(j);else return j}return h?e:null}})();
(function(){var b=Quark.Stage=function(a){this.stageY=this.stageX=0;this.paused=!1;this._eventTarget=null;a=a||{};b.superClass.constructor.call(this,a);this.id=a.id||Quark.UIDUtil.createUID("Stage");if(null==this.context)throw"Quark.Stage Error: context is required.";this.updatePosition()};Quark.inherit(b,Quark.DisplayObjectContainer);b.prototype.step=function(a){this.paused||(this._update(a),this._render(this.context))};b.prototype._update=function(a){for(var c=this.children.slice(0),b=0,h=c.length;b<
h;b++){var e=c[b];e._depth=b+1;e._update(a)}null!=this.update&&this.update(a)};b.prototype._render=function(a){null!=a.clear&&a.clear(0,0,this.width,this.height);b.superClass._render.call(this,a)};b.prototype._onEvent=function(a){var c=a.pageX||a.clientX,b=a.pageY||a.clientY,c=(c-this.stageX)/this.scaleX,b=(b-this.stageY)/this.scaleY,h=this.getObjectUnderPoint(c,b,!0),e=this._eventTarget;a.eventX=c;a.eventY=b;if(null!=e&&e!=h)a.lastEventTarget=e,(c="mousemove"==a.type?"mouseout":"touchmove"==a.type?
"touchout":null)&&e._onEvent({type:c}),this._eventTarget=null;if(null!=h&&h.eventEnabled)a.eventTarget=e=this._eventTarget=h,h._onEvent(a);if(!Quark.supportTouch)this.context.canvas.style.cursor=e&&e.useHandCursor&&e.eventEnabled?"pointer":"";if(null!=this.onEvent)this.onEvent(a)};b.prototype.updatePosition=function(){var a=Quark.getElementOffset(this.context.canvas);this.stageX=a.left;this.stageY=a.top}})();
...
c.src=b+".webm"):alert("Your browser does not support the video tag.");a?g.play():g.pause();g.addEventListener("ended",function(){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.VIDEO_PLAY_ENDED})},!1);g.addEventListener("playing",function(){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.VIDEO_START_PLAY})},!1);return g}})();(function(){aJSs.MaskEffect=function(b){this.transTotal=68;this.maskerFull=0;var a=this,c,d;this.transition=function(a,b,c,d,i){this.maskerFull=0;if(a<=this.transTotal)this["mask"+a](b,c,d,i);else this.transition(68,b,c,d,i)};this.mask1=function(h,e,g,j){function i(){p=e*m*d;n=g*m*d;f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.setRect([0,0,e,g]),clearInterval(o),o=null}var f=h.getChildAt(0),k=0,l=0,p=0,n=
0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask2=function(h,e,g,j){function i(){p=e*m*d;f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),clearInterval(o),o=null}var f=h.getChildAt(0),k=0,l=0,p=0,n=g;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask3=function(h,e,g,j){function i(){n=g*m*d;f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
f.setRect([0,0,e,g]),clearInterval(o),o=null}var f=h.getChildAt(0),k=0,l=0,p=e,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask4=function(h,e,g,j){function i(){k=e*(1-m*d);p=e*m*d;f.x=e*(1-m*d);f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.x=0,clearInterval(o),o=null}var f=h.getChildAt(0),k=e,l=0,p=0,n=g;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask5=function(h,e,g,j){function i(){l=
g*(1-m*d);n=g*m*d;f.y=g*(1-m*d);f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.y=0,clearInterval(o),o=null}var f=h.getChildAt(0),k=0,l=g,p=e,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask6=function(h,e,g,j){function i(){n=e*u*d;f.setRect([l,p,n,o]);m=e*(1-u*d);r=e*u*d;k.x=e*(1-u*d);k.setRect([m,q,r,s]);u++;if(u>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
f.setRect([0,0,e,g]),h.removeChild(k),clearInterval(t),t=null}var f=h.getChildAt(0),k=new Quark.Bitmap({id:"targetBitmap2",image:f.image,rect:[0,0,0,0]});h.addChild(k);var l=0,p=0,n=0,o=g,m=e,q=0,r=0,s=g;c=j*b;d=1/(2*c);var t=setInterval(i,1E3/b),u=1;i()};this.mask7=function(h,e,g,j){function i(){o=g*u*d;f.setRect([l,p,n,o]);q=g*(1-u*d);s=g*u*d;k.y=g*(1-u*d);k.setRect([m,q,r,s]);u++;if(u>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,
e,g]),h.removeChild(k),clearInterval(t),t=null}var f=h.getChildAt(0),k=new Quark.Bitmap({id:"targetBitmap2",image:f.image,rect:[0,0,0,0]});h.addChild(k);var l=0,p=0,n=e,o=0,m=0,q=g,r=e,s=0;c=j*b;d=1/(2*c);var t=setInterval(i,1E3/b),u=1;i()};this.mask8=function(h,e,g,j){function i(){k=e/2*(1-m*d);p=e*m*d;f.x=e/2*(1-m*d);f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.x=0,clearInterval(o),o=null}var f=
h.getChildAt(0),k=e/2,l=0,p=0,n=g;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask9=function(h,e,g,j){function i(){l=g/2*(1-m*d);n=g*m*d;f.y=g/2*(1-m*d);f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.y=0,clearInterval(o),o=null}var f=h.getChildAt(0),k=0,l=g/2,p=e,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask10=function(h,e,g,j){function i(){for(var b=0;b<l;b++){var j=b*p,i=
p*q*d,k=g;h.getChildById("maskBitmap"+b).setRect([j,0,i,k])}q++;if(q>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(f.setRect([0,0,e,g]);1<h.getNumChildren();)h.removeChildAt(h.getNumChildren()-1);clearInterval(m);m=null}}for(var f=h.getChildAt(0),k=f.image,l=16,p=e/l,n=0;n<l;n++){var o=new Quark.Bitmap({id:"maskBitmap"+n,image:k,rect:[0,0,0,0]});o.x=n*p;h.addChild(o)}c=j*b;d=1/c;var m=setInterval(i,1E3/b),q=1;i()};this.mask11=function(h,e,g,j){function i(){for(var b=
0;b<l;b++){var j=b*p,i=e,k=p*q*d;h.getChildById("maskBitmap"+b).setRect([0,j,i,k])}q++;if(q>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(f.setRect([0,0,e,g]);1<h.getNumChildren();)h.removeChildAt(h.getNumChildren()-1);clearInterval(m);m=null}}for(var f=h.getChildAt(0),k=f.image,l=16,p=g/l,n=0;n<l;n++){var o=new Quark.Bitmap({id:"maskBitmap"+n,image:k,rect:[0,0,0,0]});o.y=n*p;h.addChild(o)}c=j*b;d=1/c;var m=setInterval(i,1E3/b),q=1;i()};this.mask12=
function(h,e,g,j){function i(){for(n=0;n<A;n++)w=m.length,0<w?(y=Math.floor(Math.random()*w),m[y].visible=!0,m.splice(y,1)):n=A;x++;if(x>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(f.setRect([0,0,e,g]);1<h.getNumChildren();)h.removeChildAt(h.getNumChildren()-1);clearInterval(u);u=null}}for(var f=h.getChildAt(0),k=f.image,l=Math.ceil(e/20),p=Math.ceil(g/20),n=0,o=0,m=[],n=0;20>n;n++)for(o=0;20>o;o++){var q=l*n,r=p*o,s=l,t=p;if(q<e&&
r<g)q>e-l&&(s=e-q),r>g-p&&(t=g-r),s=new Quark.Bitmap({id:"maskBitmap"+n+o,image:k,rect:[q,r,s,t]}),s.x=q,s.y=r,s.visible=!1,h.addChild(s),m.push(s)}c=j*b;d=1/c;var u=setInterval(i,1E3/b),x=1,w=m.length,y,A=Math.round(w/c);1>A&&(A=1);i()};this.mask13=function(h,e,g,j){function i(){k=e/2*(1-m*d);l=g/2*(1-m*d);p=e*m*d;n=g*m*d;f.x=e/2*(1-m*d);f.y=g/2*(1-m*d);f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),
f.x=0,f.y=0,clearInterval(o),o=null}var f=h.getChildAt(0),k=e/2,l=g/2,p=0,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask14=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask15=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask16=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask17=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask18=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask19=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask20=function(a,
b,c,d){this.transition(68,a,b,c,d)};this.mask21=function(h,e,g,j){function i(){k=e*(1-m*d);l=g*(1-m*d);p=e*m*d;n=g*m*d;f.x=e*(1-m*d);f.y=g*(1-m*d);f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.x=0,f.y=0,clearInterval(o),o=null}var f=h.getChildAt(0),k=e,l=g,p=0,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask22=function(h,e,g,j){function i(){k=e*(1-m*d);l=0;p=e*m*d;n=g*m*d;f.x=e*(1-m*
d);f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.x=0,clearInterval(o),o=null}var f=h.getChildAt(0),k=e,l=0,p=0,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask23=function(h,e,g,j){function i(){k=0;l=g*(1-m*d);p=e*m*d;n=g*m*d;f.y=g*(1-m*d);f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.y=
0,clearInterval(o),o=null}var f=h.getChildAt(0),k=0,l=g,p=0,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask24=function(h,e,g,j){function i(){q=e/2*z*d;r=g/2*z*d;f.setRect([o,m,q,r]);s=e/2+e/2*(1-z*d);t=0;u=e/2*z*d;x=g/2*z*d;l.x=e/2+e/2*(1-z*d);l.setRect([s,t,u,x]);w=0;y=g/2+g/2*(1-z*d);A=e/2*z*d;F=g/2*z*d;p.y=g/2+g/2*(1-z*d);p.setRect([w,y,A,F]);G=e/2+e/2*(1-z*d);D=g/2+g/2*(1-z*d);B=e/2*z*d;C=g/2*z*d;n.x=e/2+e/2*(1-z*d);n.y=g/2+g/2*(1-z*d);n.setRect([G,D,B,C]);z++;if(z>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});
for(f.setRect([0,0,e,g]);1<h.getNumChildren();)h.removeChildAt(h.getNumChildren()-1);clearInterval(H);H=null}}var f=h.getChildAt(0),k=f.image,l=new Quark.Bitmap({id:"targetBitmap2",image:k,rect:[0,0,0,0]});h.addChild(l);var p=new Quark.Bitmap({id:"targetBitmap3",image:k,rect:[0,0,0,0]});h.addChild(p);var n=new Quark.Bitmap({id:"targetBitmap4",image:k,rect:[0,0,0,0]});h.addChild(n);var o=0,m=0,q=0,r=0,s=e,t=0,u=0,x=0,w=0,y=g,A=0,F=0,G=e,D=g,B=0,C=0;c=j*b;d=1/c;var H=setInterval(i,1E3/b),z=1;i()};this.mask25=
function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask26=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask27=function(h,e,g,j){function i(){for(var b=0;b<l;b++){var j=p*b,i=p;n[b].x>e-p&&(i=e-n[b].x);var k=o[b]+(g-o[b])*u*d*g/(g-o[b]);k<g&&n[b].setRect([j,0,i,k])}u++;if(u>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(f.setRect([0,0,e,g]);1<h.getNumChildren();)h.removeChildAt(h.getNumChildren()-1);clearInterval(t);t=null}}for(var f=
h.getChildAt(0),k=f.image,l=20,p=Math.ceil(e/l),n=[],o=[],m=0;m<l;m++){o[m]=g/2*Math.random();var q=p*m,r=p,s=o[m];q>e-p&&(r=e-q);r=new Quark.Bitmap({id:"maskBitmap"+m,image:k,rect:[q,0,r,s]});r.x=q;h.addChild(r);n.push(r)}c=j*b;d=1/c;var t=setInterval(i,1E3/b),u=1;i()};this.mask28=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask29=function(h,e,g,j){function i(){f.alpha=l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.alpha=
1,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.alpha=0;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask30=function(h,e,g,j){function i(){k=e*(1-m*d);p=e*m*d;f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.x=0,clearInterval(o),o=null}var f=h.getChildAt(0),k=e,l=0,p=0,n=g;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask31=function(h,e,g,j){function i(){f.alpha=
m*d;k=e*(1-m*d);p=e*m*d;f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.x=0,f.alpha=1,clearInterval(o),o=null}var f=h.getChildAt(0);f.alpha=0;var k=e,l=0,p=0,n=g;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask32=function(h,e,g,j){function i(){p=e*m*d;f.setRect([k,l,p,n]);f.x=e*(1-m*d);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,
0,e,g]),f.x=0,clearInterval(o),o=null}var f=h.getChildAt(0);f.x=e;var k=0,l=0,p=0,n=g;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask33=function(h,e,g,j){function i(){f.alpha=m*d;p=e*m*d;f.setRect([k,l,p,n]);f.x=e*(1-m*d);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.x=0,f.alpha=1,clearInterval(o),o=null}var f=h.getChildAt(0);f.x=e;var k=f.alpha=0,l=0,p=0,n=g;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};
this.mask34=function(h,e,g,j){function i(){l=g*(1-m*d);n=g*m*d;f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.y=0,clearInterval(o),o=null}var f=h.getChildAt(0),k=0,l=g,p=e,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask35=function(h,e,g,j){function i(){f.alpha=m*d;l=g*(1-m*d);n=g*m*d;f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
f.setRect([0,0,e,g]),f.y=0,f.alpha=1,clearInterval(o),o=null}var f=h.getChildAt(0),k=f.alpha=0,l=g,p=e,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask36=function(h,e,g,j){function i(){f.y=g*(1-m*d);n=g*m*d;f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.y=0,clearInterval(o),o=null}var f=h.getChildAt(0);f.y=g;var k=0,l=0,p=e,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask37=
function(h,e,g,j){function i(){f.alpha=m*d;f.y=g*(1-m*d);n=g*m*d;f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),f.y=0,f.alpha=1,clearInterval(o),o=null}var f=h.getChildAt(0);f.alpha=0;f.y=g;var k=0,l=0,p=e,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask38=function(h,e,g,j){function i(){f.width=e*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
f.width=e,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.width=0;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask39=function(h,e,g,j){function i(){f.alpha=l*d;f.width=e*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.width=e,f.alpha=1,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.alpha=0;f.width=0;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask40=function(h,e,g,
j){function i(){f.x=e/2*(1-l*d);f.width=e*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.width=e,f.x=0,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.width=0;f.x=e/2;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask41=function(h,e,g,j){function i(){f.alpha=l*d;f.x=e/2*(1-l*d);f.width=e*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
f.width=e,f.x=0,f.alpha=1,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.width=0;f.alpha=0;f.x=e/2;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask42=function(h,e,g,j){function i(){f.x=e*(1-l*d);f.width=e*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.width=e,f.x=0,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.width=0;f.x=e;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};
this.mask43=function(h,e,g,j){function i(){f.alpha=l*d;f.x=e*(1-l*d);f.width=e*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.width=e,f.x=0,f.alpha=1,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.width=0;f.alpha=0;f.x=e;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask44=function(h,e,g,j){function i(){f.height=g*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
f.height=g,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.height=0;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask45=function(h,e,g,j){function i(){f.alpha=l*d;f.height=g*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.height=g,f.alpha=1,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.height=0;f.alpha=0;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask46=function(h,
e,g,j){function i(){f.y=g/2*(1-l*d);f.height=g*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.height=g,f.y=0,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.height=0;f.y=g/2;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask47=function(h,e,g,j){function i(){f.alpha=l*d;f.y=g/2*(1-l*d);f.height=g*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
f.height=g,f.y=0,f.alpha=1,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.height=0;f.alpha=0;f.y=g/2;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask48=function(h,e,g,j){function i(){f.y=g*(1-l*d);f.height=g*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.height=g,f.y=0,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.height=0;f.y=g;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;
i()};this.mask49=function(h,e,g,j){function i(){f.alpha=l*d;f.y=g*(1-l*d);f.height=g*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.height=g,f.y=0,f.alpha=1,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.height=0;f.alpha=0;f.y=g;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask50=function(h,e,g,j){function i(){f.x=e/2*(1-l*d);f.y=g/2*(1-l*d);f.width=e*l*d;f.height=g*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
f.width=e,f.height=g,f.x=0,f.y=0,clearInterval(k),k=null}var f=h.getChildAt(0);f.setRect([0,0,e,g]);f.width=0;f.height=0;f.x=e/2;f.y=g/2;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask51=function(h,e,g,j){function i(){f.alpha=l*d;f.x=e/2*(1-l*d);f.y=g/2*(1-l*d);f.width=e*l*d;f.height=g*l*d;l++;if(l>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.width=e,f.height=g,f.x=0,f.y=0,f.alpha=1,clearInterval(k),k=null}var f=h.getChildAt(0);
f.setRect([0,0,e,g]);f.width=0;f.height=0;f.alpha=0;f.x=e/2;f.y=g/2;c=j*b;d=1/c;var k=setInterval(i,1E3/b),l=1;i()};this.mask52=function(a,b,c){a.getChildAt(0).setRect([0,0,b,c]);aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER})};this.mask53=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask54=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask55=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask56=function(a,b,c,d){this.transition(68,a,b,c,d)};
...
a,b,c,d)};this.mask66=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask67=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask68=function(h,e,g,j){function i(){for(n=0;n<z;n++)m[n].width=u[n]*H*d,m[n].height=x[n]*H*d,m[n].x=s[n]+(q[n]-s[n])*H*d,m[n].y=t[n]+(r[n]-t[n])*H*d;H++;if(H>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(f.setRect([0,0,e,g]);1<h.getNumChildren();)h.removeChildAt(h.getNumChildren()-1);clearInterval(C);
C=null}}for(var f=h.getChildAt(0),k=f.image,l=Math.ceil(e/12),p=Math.ceil(g/12),n=0,o=0,m=[],q=[],r=[],s=[],t=[],u=[],x=[],n=0;12>n;n++)for(o=0;12>o;o++){var w=l*n,y=p*o,A=l,F=p,G=Math.random()*(e-l),D=Math.random()*(g-p);if(w<e&&y<g){w>e-l&&(A=e-w);y>g-p&&(F=g-y);var B=new Quark.Bitmap({id:"maskBitmap"+n+o,image:k,rect:[w,y,A,F]});B.x=G;B.y=D;B.width=0;B.height=0;h.addChild(B);m.push(B);q.push(w);r.push(y);u.push(A);x.push(F);s.push(G);t.push(D)}}c=j*b;d=1/c;var C=setInterval(i,1E3/b),H=1,z=m.length;
...
"";a.musicAutoPlay="";a.topPadding=0;a.bottomPadding=0;a.leftPadding=0;a.rightPadding=0;a.enableDes="";a.desAlign="";a.desBackgroundColor="";a.desBackgroundAlpha="";a.desTextFont="Lucida Sans Unicode";a.desTextSize=10;a.desTextColor=0;a.desLineHeight=16;a.videoAutoPlay="";a.bufferTime="";a.videoControls="";a.dotsPerGroup="";a.dotsSpacing="";a.dotsPosition="";a.thumbnailArray=[];a.photoArray=[];a.photoUrlArray=[];a.URLTarget=[];a.videoArray=[];a.transitionArray=[];a.photoTimeArray=[];a.transitionTimeArray=
[];a.defineTransitionArray=[];a.photoTitleArray=[];a.descriptionText=[];var c=function(b){b=b.documentElement;a.copyright=b.getAttribute("copyright");var c=b.getElementsByTagName("global")[0],d=c.getElementsByTagName("basic_property")[0];a.movieWidth=d.getAttribute("movieWidth");a.movieHeight=d.getAttribute("movieHeight");a.startAutoPlay=d.getAttribute("startAutoPlay");a.continuum=d.getAttribute("continuum");a.clickToAutoPlay=d.getAttribute("clickToAutoPlay");a.randomPlayingPhotos=d.getAttribute("randomPlayingPhotos");
a.enableURL=d.getAttribute("enableURL");a.movieBackgroundColor=d.getAttribute("backgroundColor").replace(/0x/g,"#");a.loadStyle=d.getAttribute("loadStyle");a.anvsoftMenu=d.getAttribute("anvsoftMenu");a.frameRate=d.getAttribute("frameRate");d=d.getAttribute("transitionArray");a.defineTransitionArray=""==d?null:d.split(",");d=c.getElementsByTagName("title_property")[0];a.showTitle=d.getAttribute("showTitle");a.photoTitleColor=d.getAttribute("photoTitleColor").replace(/0x/g,"#");a.photoTitleBackgroundColor=
d.getAttribute("backgroundColor").replace(/0x/g,"#");a.photoTitleAlpha=d.getAttribute("alpha")/100;a.photoTitleAutoHide=d.getAttribute("autoHide");a.titleTextFont=d.getAttribute("titleTextFont");a.titleTextSize=d.getAttribute("titleTextSize");a.titleTextHeight=d.getAttribute("titleTextHeight");d=c.getElementsByTagName("music_property")[0];a.musicPath=d.getAttribute("path");a.musicStream=d.getAttribute("stream");a.musicLoop=d.getAttribute("loop");a.musicAutoPlay=d.getAttribute("autoPlay");d=c.getElementsByTagName("photo_property")[0];
a.topPadding=Number(d.getAttribute("topPadding"));a.bottomPadding=Number(d.getAttribute("bottomPadding"));a.leftPadding=Number(d.getAttribute("leftPadding"));a.rightPadding=Number(d.getAttribute("rightPadding"));d=c.getElementsByTagName("description_property")[0];a.enableDes=d.getAttribute("enable");a.desAlign=d.getAttribute("align");a.desBackgroundColor=d.getAttribute("backgroundColor").replace(/0x/g,"#");a.desBackgroundAlpha=d.getAttribute("backgroundAlpha")/100;a.desTextFont=d.getAttribute("defaultTextFont");
a.desTextSize=d.getAttribute("defaultTextSize");a.desTextColor=d.getAttribute("defaultTextColor").replace(/0x/g,"#");a.desLineHeight=Number(d.getAttribute("lineHeight"));c=c.getElementsByTagName("video_property")[0];a.videoAutoPlay=c.getAttribute("autoPlay");a.bufferTime=Number(c.getAttribute("bufferTime"));a.videoControls=c.getAttribute("controls");c=b.getElementsByTagName("thumbnail")[0].getElementsByTagName("basic_property")[0];a.dotsPerGroup=Number(c.getAttribute("dotsPerGroup"));a.dotsSpacing=
Number(c.getAttribute("dotsSpacing"));a.dotsPosition=c.getAttribute("dotsPosition");b=b.getElementsByTagName("album")[0].getElementsByTagName("slide");c=b.length;for(d=0;d<c;d++){a.thumbnailArray[d]=b[d].getAttribute("jpegURL");a.photoArray[d]=b[d].getAttribute("d_URL");a.photoUrlArray[d]=b[d].getAttribute("url");a.URLTarget[d]=b[d].getAttribute("URLTarget");a.videoArray[d]=b[d].getAttribute("v_URL");a.transitionArray[d]=b[d].getAttribute("transition");a.photoTimeArray[d]=b[d].getAttribute("phototime");
a.transitionTimeArray[d]=b[d].getAttribute("transitiontime");a.photoTitleArray[d]=b[d].getAttribute("title");var e=b[d].childNodes[0];a.descriptionText[d]=void 0!=e?e.nodeValue:""}};try{var d=new ActiveXObject("Microsoft.XMLDOM")}catch(h){try{d=document.implementation.createDocument("","",null)}catch(e){alert(e.message)}}try{d.async=!1,d.load(b),c(d)}catch(g){try{var j=new window.XMLHttpRequest;j.open("GET",b,!1);j.send(null);d=j.responseXML;c(d)}catch(i){d=(new DOMParser).parseFromString(window.anvsoftJavaScriptSlideshowData,
"text/xml"),c(d)}}}})();(function(){aJSs.JsBackground=function(b,a){var c=b.movieBackgroundColor,d=new Quark.DisplayObjectContainer({id:"backgroundBox"});d.autoSize=!0;a.addChild(d);if(""!=c){var h=Quark.Bitmap,e=a.width,g=a.height,j=document.createElement("canvas");j.width=e;j.height=g;var i=j.getContext("2d");i.fillStyle=c;i.rect(0,0,e,g);i.fill();c=new Image;c.src=j.toDataURL("image/png");c.width=e;c.height=g;h=new h({id:"background",image:c});h.autoSize=!0;d.addChild(h)}}})();(function(){aJSs.JsPhoto=function(b,a,c){function d(){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.VIDEO_CLEAR});e();B=D=0;O&&O.removeAllChildren();I.swapChildren(M,N);I.getChildIndex(M)>I.getChildIndex(N)?(P=M,O=N):(P=N,O=M);var a=new Image;a.onload=function(){g();D=1;a.width=R;a.height=S;var b=new Quark.Bitmap({id:"targetBitmap",image:a,rect:[0,0,0.0010,0.0010]});b.useHandCursor="true"==k&&""!=f[v]?!0:!1;P.addChild(b);H=0==n[v]?null==o?Math.floor(Math.random()*L.transTotal)+
1:o[Math.floor(Math.random()*o.length)]:n[v];L.transition(H,P,R,S,m[v]);b.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type){if("true"==k&&""!=f[v]){switch(l[v]){case "0":a="_blank";break;case "1":a="_parent";break;case "2":a="_self";break;case "3":a="_top";break;default:a="_blank"}window.open(f[v],a)}}else"mousemove"==a.type||"touchmove"==a.type?aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_MOUSE_OVER}):("mouseout"==a.type||"touchout"==a.type)&&aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_MOUSE_OUT})};
aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_LOAD_COMPLETE,index:v})};a.src=c+i[v];aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_CURRENT,index:v})}function h(){z--;try{Quark.getDOM("debugInfo").value=z}catch(a){}if(0>=z||1==C)clearInterval(E),E=null,0==C?"true"==u?v=Math.floor(Math.random()*J):v<J-1?v++:v=0:C=0,d()}function e(){if(""!=x){g();var a=new Image;a.src=c+x;a=new Quark.MovieClip({image:a,id:"preloader",interval:100});a.addFrame([{rect:[0,
0,25,25]},{rect:[25,0,25,25]},{rect:[50,0,25,25]},{rect:[75,0,25,25]},{rect:[100,0,25,25]},{rect:[125,0,25,25]}]);a.x=s+(A-a.width)/2;a.y=q+(F-a.height)/2;K.addChild(a)}}function g(){if(""!=x){var a=K.getChildById("preloader");null!=a&&K.removeChild(a)}}var j=b.frameRate,i=b.photoArray,f=b.photoUrlArray,k=b.enableURL,l=b.URLTarget,p=b.photoTimeArray,n=b.transitionArray,o=b.defineTransitionArray,m=b.transitionTimeArray,q=b.topPadding,r=b.bottomPadding,s=b.leftPadding,t=b.rightPadding,u=b.randomPlayingPhotos,
x=b.loadStyle,w=b.videoAutoPlay,y=b.videoArray,A=a.width-s-t,F=a.height-q-r,G=0,D=1,B=1,C=0,H=0,z=0,v=0,E=null,J=i.length;aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.TRANSITION_OVER,function(){B=1;if(1==G||1==C)z=p[v]*j,E=setInterval(h,1E3/j);""!=y[v]&&void 0!=y[v]&&0==C&&("true"==w&&(clearInterval(E),E=null),aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_VIDEO,index:v,width:A,height:F}))});var L=new aJSs.MaskEffect(j),K=new Quark.DisplayObjectContainer({id:"container"});
...
N=new Quark.DisplayObjectContainer({id:"bPhoto"});I.addChild(M);I.addChild(N);this.Play=function(){G=1;1==D&&1==B?(clearInterval(E),E=null,v<J-1?v++:v=0,d()):1==D&&0==B?(C=1,v<J-1?v++:v=0,L.maskerFull=1):(v<J-1?v++:v=0,C=1)};this.Pause=function(){G=0;null!=E&&(clearInterval(E),E=null)};this.Previous=function(a){G=a;0<v?v--:v=J-1;1==D&&1==B?(clearInterval(E),E=null,d()):1==D&&0==B?(C=1,L.maskerFull=1):C=1};this.Next=function(a){G=a;v<J-1?v++:v=0;1==D&&1==B?(clearInterval(E),E=null,d()):1==D&&0==B?
(C=1,L.maskerFull=1):C=1};this.Show=function(a,b){G=b;1==D&&1==B?(clearInterval(E),E=null,v=a,d()):1==D&&0==B?(C=1,v=a,L.maskerFull=1):(v=a,C=1)}}})();(function(){aJSs.JsDescription=function(b,a){function c(b){q=l[b.index];""!=q?(b=A.getChildById("description"),A.removeChild(b),b=new Quark.Bitmap({id:"description",image:h(k,f,i,q)}),A.addChild(b),F.height=t,y.y="top"==e?n:a.height-o-t,y.visible=!0):(y.visible=!1,t=0,F.height=0)}function d(a,b,c){var d=document.createElement("canvas");d.width=a;d.height=b;var e=d.getContext("2d");e.fillStyle=c;e.rect(0,0,a,b);e.fill();c=new Image;c.src=d.toDataURL("image/png");c.width=a;c.height=b;return c}function h(b,
c,d,e){var f=document.createElement("canvas");f.width=a.width;f.height=a.height;var g=f.getContext("2d");g.font=c+"px "+d;g.textAlign="start";g.textBaseline="top";g.fillStyle=b;for(var c=b=r,d=x,h=p,e=e.split(" "),i="",j=1,l=0;l<e.length;l++){var k=i+e[l]+" ";g.measureText(k).width>d?(g.fillText(i,b,c),i=e[l]+" ",c+=h,j++):i=k}g.fillText(i,b,c);w=j*h;t=w+2*r;t>u&&(t=u);g=new Image;g.src=f.toDataURL("image/png");g.width=s;g.height=t;return g}var e=b.desAlign,g=b.desBackgroundColor,j=b.desBackgroundAlpha,
i=b.desTextFont,f=b.desTextSize,k=b.desTextColor,l=b.descriptionText,p=b.desLineHeight,n=b.topPadding,o=b.bottomPadding,m=b.leftPadding,q=l[0],r=4,s=a.width-m-b.rightPadding,t=0,u=a.height-n-o,x=s-2*r,w;if("true"==b.enableDes){var y=new Quark.DisplayObjectContainer({id:"desContainer"});y.autoSize=!0;y.visible=!1;y.x=m;y.y="top"==e?n:a.height-o-t;a.addChild(y);var A=new Quark.DisplayObjectContainer({id:"desBox"});A.autoSize=!0;y.addChild(A);var F=new Quark.Bitmap({id:"desBackground",image:d(s,p,g)});
F.autoSize=!0;F.alpha=j;A.addChild(F);g=new Quark.Bitmap({id:"description",image:h(k,f,i,q)});A.addChild(g);aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PHOTO_LOAD_COMPLETE,c)}}})();(function(){aJSs.JsPhotoTitle=function(b,a){function c(a){if("photoMouseOver"==a.type)u.visible=!0;else if("photoMouseOut"==a.type)u.visible=!1}function d(a){r=o[a.index];if(""!=r){a=u.getChildById("photoTitle");u.removeChild(a);a=new Quark.Bitmap({id:"photoTitle",image:e(q,p,g,l,k,r)});if(s<q)a.x=Math.round((q-s)/2);u.addChild(a);t.visible=!0}else t.visible=!1}function h(a,b,c){var d=document.createElement("canvas");d.width=a;d.height=b;var e=d.getContext("2d");e.fillStyle=c;e.rect(0,0,a,b);e.fill();
c=new Image;c.src=d.toDataURL("image/png");c.width=a;c.height=b;return c}function e(a,b,c,d,e,f){var g=document.createElement("canvas");g.width=a;g.height=b;var h=g.getContext("2d");h.font=d+"px "+e;h.textAlign="start";h.textBaseline="middle";h.fillStyle=c;h.fillText(f,0,b/2);s=h.measureText(f).width;c=new Image;c.src=g.toDataURL("image/png");c.width=a;c.height=b;return c}var g=b.photoTitleColor,j=b.photoTitleBackgroundColor,i=b.photoTitleAlpha,f=b.photoTitleAutoHide,k=b.titleTextFont,l=b.titleTextSize,
p=b.titleTextHeight,n=b.topPadding,o=b.photoTitleArray,m=b.leftPadding,q=a.width-m-b.rightPadding,r=o[0],s;if("true"==b.showTitle){var t=new Quark.DisplayObjectContainer({id:"photoTitleContainer"});t.autoSize=!0;t.visible=!1;t.x=m;t.y=n;a.addChild(t);var u=new Quark.DisplayObjectContainer({id:"photoTitleBox"});u.autoSize=!0;t.addChild(u);j=new Quark.Bitmap({id:"titleBackground",image:h(q,p,j)});j.autoSize=!0;j.alpha=i;u.addChild(j);i=new Quark.Bitmap({id:"photoTitle",image:e(q,p,g,l,k,r)});if(s<q)i.x=
Math.round((q-s)/2);u.addChild(i);if("true"==f)u.visible=!1,aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PHOTO_MOUSE_OVER,c),aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PHOTO_MOUSE_OUT,c);aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PHOTO_LOAD_COMPLETE,d)}}})();(function(){aJSs.JsMediaConsole=function(b,a,c,d){function h(){void 0!=t&&(b.removeChild(t),void 0!=r&&"videoCallPause"==u&&(s.gotoAndStop(0),r.Play(),u=""),t=void 0,e())}function e(){var a=document.getElementById("videoLoadText");a&&b.removeChild(a)}var g=a.topPadding,j=a.leftPadding,i=a.rightPadding,f=a.musicPath,k=a.musicAutoPlay,l=a.musicLoop,p=a.musicStream,n=a.videoAutoPlay,o=a.bufferTime,m=a.videoArray,q=a.videoControls;if(""!=f){var r=new aJSs.Music(d+f,p,k,l),a=new Quark.DisplayObjectContainer({id:"consoleBox"});
a.autoSize=!0;c.addChild(a);f=new Image;f.src=d+"res/sound.png";var s=new Quark.MovieClip({image:f,interval:100});s.useHandCursor=!0;s.stop();s.addFrame([{rect:[0,0,30,30],index:0},{rect:[30,0,30,30],index:1}]);a.addChild(s);s.x=c.width-s.width-i;s.y=g;"true"!=k&&s.gotoAndStop(1);s.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type)r.Playing()?(s.gotoAndStop(1),r.Pause()):(s.gotoAndStop(0),r.Play())};aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.SOUND_PLAY_COMPLETE,
function(){s.gotoAndStop(1)})}var t,u="";aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_VIDEO,function(a){var c=a.index,e=a.width,a=a.height;void 0!=r&&r.Playing()&&(s.gotoAndStop(1),r.Pause(),u="videoCallPause");t=new aJSs.Video(d+m[c],n,o,q,e,a);t.style.backgroundColor="#000";t.style.position="absolute";t.style.top=g+"px";t.style.left=j+"px";b.appendChild(t);c=document.getElementById("videoLoadText");if(null==c)c=document.createElement("div"),c.id="videoLoadText",c.style.position=
...
function(){e()})}})();(function(){aJSs.JsThumbnail=function(b,a,c,d){function h(a){w&&w.removeAllChildren();for(var c=0;c<k;c++){var d=a*k+c;if(d<m){var e=new Quark.DisplayObjectContainer({id:"thumBox_"+c});e.autoSize=!0;e.x=(q+l)*c;w.addChild(e);var f=new Image;f.id="listImg_"+d;f.onload=function(){f.width=q;f.height=r;var a=new Q.Button({id:"list",image:f,width:15,height:15,up:{rect:[0,0,15,15]},over:{rect:[15,0,15,15]},down:{rect:[0,0,15,15]},disabled:{rect:[30,0,15,15]}});a.autoSize=!0;a.index=d;e.addChild(a);a.onEvent=
function(a){if("mousedown"==a.type||"touchend"==a.type)a=a.eventTarget,"true"==i?(x.visible=!1,b.Show(a.index,1)):(x.visible=!0,b.Show(a.index,0))}}();f.src=s}}w.getChildAt(0).getChildById("list").changeState("disabled");t=0}var e=a.leftPadding,g=a.startAutoPlay,j=a.continuum,i=a.clickToAutoPlay,f=a.randomPlayingPhotos,k=a.dotsPerGroup,l=a.dotsSpacing,p=a.dotsPosition,n=0,o=0,m=a.thumbnailArray.length,q=15,r=15,s=d+"res/dots.png",t=0;aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_CURRENT,
function(a){o=a.index;a=Math.floor(o/k);n!=a&&!isNaN(a)&&(n=a,h(n));w&&(a=o%k,w.getChildAt(t).getChildById("list").changeState("up"),w.getChildAt(a).getChildById("list").changeState("disabled"),t=a);if(o>=m-1&&"false"==j&&"false"==f)x.visible=!0,b.Pause()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_START_PLAY,function(){x.visible=!0;b.Pause()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_NEXT,function(){x.visible=!1;b.Play()});a=new Quark.DisplayObjectContainer({id:"thumbnailBox"});
a.autoSize=!0;c.addChild(a);var u=new Image;u.src=d+"res/play.png";var x=new Q.Button({id:"playButton",image:u,width:45,height:45,up:{rect:[0,0,45,45]},over:{rect:[45,0,45,45]},down:{rect:[0,0,45,45]}});a.addChild(x);x.x=e;x.y=(c.height-x.height)/2;"true"==g?(x.visible=!1,b.Show(0,1)):(x.visible=!0,b.Show(0,0));x.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type)x.visible=!1,b.Play()};var w=new Quark.DisplayObjectContainer({id:"thumSpBox"});w.autoSize=!0;a.addChild(w);Math.ceil(m/k);
w.x=(c.width-(m>k?k*(q+l)-l:m*(q+l)-l))/2;w.y="bottom"==p?c.height-2*r:r;h(0)}})();(function(){aJSs.JsMenu=function(b,a){function c(a,b,c){var d=document.createElement("canvas");d.width=a;d.height=b;var e=d.getContext("2d");e.fillStyle=c;e.rect(0,0,a,b);e.fill();c=new Image;c.src=d.toDataURL("image/png");c.width=a;c.height=b;return c}function d(a,b,c,d,e,f){var l;var g=document.createElement("canvas");g.width=a;g.height=b;a=g.getContext("2d");a.font=d+"px "+e;a.textAlign="start";a.textBaseline="middle";a.fillStyle=c;a.fillText(f,0,b/2);l=k=a.measureText(f).width,a=l;c=new Image;
c.src=g.toDataURL("image/png");c.width=a;c.height=b;return c}var h=b.topPadding,e=b.leftPadding,g=b.copyright;if(null==b.anvsoftMenu||"anvsoftPFMTheme"!=g&&"anvsoftUSSTheme"!=g&&"anvsoftHSMTheme"!=g){var j,i;switch(g){case "anvsoftPFMTheme":i="Powered by photo-flash-maker.com";j=186;break;case "anvsoftUSSTheme":i="Powered by ultraslideshow.com";j=168;break;case "anvsoftHSMTheme":i="Powered by html5-slideshow-maker.com";j=210;break;default:i="Powered by anvsoft.com",j=136}var f=new Quark.DisplayObjectContainer({id:"menudBox"});
f.autoSize=!0;f.x=e;f.y=h;a.addChild(f);h=new Quark.Bitmap({id:"copyrightBg",image:c(j,20,"#000")});h.autoSize=!0;h.alpha=0.3;f.addChild(h);var k=j;i=new Quark.Bitmap({id:"copyrightText",image:d(k,20,"#FFF",11,"arial, sans-serif",i)});i.useHandCursor=!0;i.autoSize=!0;i.x=Math.round((j-k)/2);f.addChild(i);i.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type)switch(g){case "anvsoftPFMTheme":window.open("http://www.photo-flash-maker.com/","_self");break;case "anvsoftUSSTheme":window.open("http://www.ultraslideshow.com/",
"_self");break;case "anvsoftHSMTheme":window.open("http://www.html5-slideshow-maker.com/","_self");break;default:window.open("http://www.anvsoft.com/","_self")}}}}})();(function(){var b=aJSs.getParameters.parameters().xml_path,a=aJSs.getParameters.parameters().fs_path,c,d;void 0==b?void 0==a?(c="slides.xml",d=""):(c=a+"/slides.xml",d=a+"/"):(c=b,d=b.substr(0,b.lastIndexOf("/")+1));anvsoftJavaScriptSlideshow.init=function(a){var b,g,j,i;(function(){i=Quark.getDOM(a);var c=Quark.supportTouch?["touchstart","touchmove","touchend","touchout"]:["mousedown","mousemove","mouseup","mouseout"],d=Quark.getUrlParams();if(void 0==d.mode)d.mode=1;var l=i.clientWidth||i.offsetWidth,
p=i.clientHeight||i.offsetHeight;1==d.mode?(b=Quark.createDOM("canvas",{width:l,height:p}),i.appendChild(b),g=new Quark.CanvasContext({canvas:b})):g=new Quark.DOMContext({canvas:i});j=new Quark.Stage({width:l,height:p,context:g});(new Q.EventManager).registerStage(j,c)})();(function(){var a=new aJSs.JsXmlLoad(c);new aJSs.JsBackground(a,j);var b=new aJSs.JsPhoto(a,j,d);new aJSs.JsDescription(a,j);new aJSs.JsPhotoTitle(a,j);new aJSs.JsMediaConsole(i,a,j,d);new aJSs.JsThumbnail(b,a,j,d);new aJSs.JsMenu(a,
j);a=new Q.Timer(1E3/a.frameRate);a.addListener(j);a.start()})()}})(window);
