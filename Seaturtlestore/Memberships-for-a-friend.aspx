<%@ Page Title="Membership tax deductible for a Friend" Language="C#"
MasterPageFile="~/Site.Master" AutoEventWireup="true"
CodeBehind="Memberships-for-a-friend.aspx.cs"
Inherits="Seaturtlestore.Memberships_for_a_friend" %> <%--<%@ Register
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
  <div class="text-center">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3><em>NEW TAX DEDUCTIBLE MEMBERSHIP OFFER</em></h3>
      </div>
    </div>
  </div>
  ...
  <div class="text-center">
    <b>
      ...
      Florida Environmental Outreach Magazine.</b
    >
  </div>

  <div>
    <div class="text-center" style="padding-top: 10px; padding-bottom: 10px">
      <b>Please send a gift to my friend : $25.00</b>
    </div>
    <div class="col-lg-7">
      <div>
    ...
    <div class="col-lg-5">
      ...
      <div style="margin-top: 15px">
        <a
          ...
          >Click Here to Order Membership For Yourself</a
        >
      </div>
    </div>
  </div>
